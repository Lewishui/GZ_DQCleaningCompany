...
namespace Order.Common
{
    ...
    public static class SQLiteHelper
    {
        ...
        public static string connStr = "Data Source=" + AppDomain.CurrentDomain.BaseDirectory + "System\\CDCompanyData.sqlite"; //ElandSalseDailyReport_qianduan   ElandSalseDailyReport1
